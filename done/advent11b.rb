...
def execute_round
  @monkeys.each do |monkey|
    ...
    monkey.worry_less(@magic_numbers.reduce(&:lcm))
    throw_items(monkey)
  end
  @round_counter += 1
end
...
while @round_counter < NUM_ROUNDS do
  puts @round_counter if @round_counter % 10 == 0
  execute_round
end
...
puts "Magic number: #{@magic_numbers.reduce(&:lcm)}"